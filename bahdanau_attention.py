...
if __name__ == "__main__":
    ...
    input_lang, output_lang, pairs = prepareData('tur', 'eng', True)
    ...
    encoder = EncoderRNN(input_lang.n_words, input_embedding_dim, hidden_size, num_layers=1, bidirectional=True)
