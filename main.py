...
def readLangs(lang1, lang2, reverse=False):
    ...
    with open('data/{}-{}/{}.txt'.format(lang1, lang2, lang1), encoding='utf-8') as f:
...
def trainIters(encoder, decoder, n_iters, print_every=1000, plot_every=100, learning_rate=0.01):
    ...
    progress = tqdm.tqdm(total=n_iters)
    for iter in range(1, n_iters + 1):
        ...
        if iter % print_every == 0:
            ...
            output_words, attentions = evaluate(encoder, decoder, sent1)
...
def evaluateAndShowAttention(input_sentence):
    output_words, attentions = evaluate(encoder, attn_decoder1, input_sentence)
...
if __name__ == "__main__":
    ...
    # output_words, attentions = evaluate(encoder, attn_decoder1, "je suis trop froid .")
    # output_words, attentions = evaluate(encoder, attn_decoder1)
